...
entity AXI_Master is
	generic (
		...
		--TODO MOVE C_M_TRANSACTIONS_NUM into input value.
		C_M_TRANSACTIONS_NUM	: integer	:= 4
	);
	port (
		-- Users to add ports here
		C_M_START_DATA_VALUE 		: in std_logic_vector(C_M_AXI_DATA_WIDTH - 1 downto 0);
		C_M_TARGET_SLAVE_BASE_ADDR 	: in std_logic_vector(C_M_AXI_ADR_WIDTH - 1 downto 0);
		-- User ports ends
